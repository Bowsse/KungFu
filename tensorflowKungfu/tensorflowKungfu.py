...
init_script = "document.getElementById('main').childNodes[1].id = 'runner-canvas';"
...
class Game:
    def __init__(self,custom_config=True):
        ...
        self._driver.get('https://hero.pizza-online.fi/#po')
        #self._driver.execute_script("Runner.config.ACCELERATION=0")
        self._driver.execute_script(init_script)
    def get_crashed(self):
        #return self._driver.execute_script("return Runner.instance_.crashed")
        # TODO: return true if crashed, false if alive. (ImageRec screen if contains text "GAME OVER")
        return
    def get_playing(self):
        #return self._driver.execute_script("return Runner.instance_.playing")
        # TODO: return true if alive. (ImageRec screen if first letters are Score, or check if not in game over screen)
        return
    def restart(self):
        self._driver.execute_script("console.log('restart :D'")
        #after game over screen click try again
    def press_up(self):
    ...
    def get_score(self):
        ...
        #return int(score)
        # TODO return game over screen score from ImageRec.
        return
    def pause(self):
...
class DinoAgent:
    def __init__(self,game): #takes game as input for taking actions
        ...
        #to start the game we need to click start or try again
    def is_running(self):
